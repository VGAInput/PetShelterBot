...
public class BotFunctions {
    ...
    public void sendPhotoReport(Update update, Long chatIdTo, Long chatIdFrom, TelegramBot tgBot) {

        ForwardMessage forwardMessage = new ForwardMessage(chatIdTo, chatIdFrom,
